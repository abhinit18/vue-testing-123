  ...
  _createClass(Category, [{
    ...
    value: function getEmojis() {
      ...
      if (name == 'Recent') {
        ...
        var frequentlyUsed = frequently.get(perLine);
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { ref: this.setContainerRef, className: 'emoji-mart-category ' + (emojis && !emojis.length ? 'emoji-mart-no-results' : ''), style: containerStyles },
        React.createElement(
          'div',
