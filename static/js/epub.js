...
})(this, function(__WEBPACK_EXTERNAL_MODULE_40__, __WEBPACK_EXTERNAL_MODULE_62__) {
...
function parse(markup, mime, forceXMLDom) {
	...
	if (typeof DOMParser === "undefined" || forceXMLDom) {
		Parser = __webpack_require__(40).DOMParser;
	} else {
		Parser = DOMParser;
	}
...
var _themes = __webpack_require__(59);
...
var _annotations = __webpack_require__(60);
  ...
  */
   ...
   */
		...
		value: function spread(_spread, min) {
			...
			if (this._layout && this._layout.spread) this._layout.spread(_spread, min);
		...
		value: function reportLocation() {
			return this.q.enqueue(function reportedLocation() {
				requestAnimationFrame(function reportedLocationAfterRAF() {
					...
					if (this.manager && this.manager.currentLocation) {} else return;
   ...
   */
		...
		value: function currentLocation() {
			if (!this.manager || !this.manager.currentLocation) return;
			var location = this.manager.currentLocation();
			if (location && location.then && typeof location.then === "function") {
				location.then(function (result) {
					var located = this.located(result);
...
var _views = __webpack_require__(79);
   ...
   */
		...
		value: function scrolledLocation() {
			...
			var sections = visible.map(function (view) {
				...
				var totalPages = _this5.layout.count(height, pageHeight).pages;
				...
				var mapping = _this5.mapping.page(view.contents, view.section.cfiBase, startPos, endPos);
		...
		value: function paginatedLocation() {
			...
			var sections = visible.map(function (view) {
				...
				var end = start + _this6.layout.width - used;

				var mapping = _this6.mapping.page(view.contents, view.section.cfiBase, start, end);
				...
				var totalPages = _this6.layout.count(width).pages;
				var startPage = Math.floor(start / _this6.layout.pageWidth);
				var pages = [];
				var endPage = Math.floor(end / _this6.layout.pageWidth);
				...
				if (_this6.settings.direction === "rtl") {
...
var _iframe = __webpack_require__(65);
...
var _continuous = __webpack_require__(80);
...
var _spine = __webpack_require__(41);

var _spine2 = _interopRequireDefault(_spine);

var _locations = __webpack_require__(52);
...
var _packaging = __webpack_require__(54);
...
var _pagelist = __webpack_require__(57);
...
var _archive = __webpack_require__(61);
...
var _xpathRange = __webpack_require__(43);
					...
					if (pos != -1) {
						...
						try {
							matches.push({
								cfi: cfi,
								excerpt: excerpt,
								range: (0, _xpathRange.fromRange)(range, section.document.body),
								query: query
							});
						} catch (ex) {}
					}
...
var _getDocument = __webpack_require__(15);

var _getDocument2 = _interopRequireDefault(_getDocument);

var _domSeek = __webpack_require__(45);

var _domSeek2 = _interopRequireDefault(_domSeek);

var _simpleXpathPosition = __webpack_require__(49);
...
var _ancestors = __webpack_require__(47);

var _ancestors2 = _interopRequireDefault(_ancestors);

var _indexOf = __webpack_require__(48);
...
var _domException = __webpack_require__(51);
		...
		value: function checkRequirements() {
			try {
				if (typeof JSZip === "undefined") {
					var _JSZip = __webpack_require__(62);
					this.zip = new _JSZip();
				} else {
					this.zip = new JSZip();
				}
...
if(typeof __WEBPACK_EXTERNAL_MODULE_62__ === 'undefined') {var e = new Error("Cannot find module \"jszip\""); e.code = 'MODULE_NOT_FOUND'; throw e;}
...
var _marksPane = __webpack_require__(66);
...
var IframeView = function () {
	...
	_createClass(IframeView, [{
		...
		value: function onLoad(event, promise) {
			...
			this.window.massiveContents = this.contents;
...
var _svg = __webpack_require__(67);
